...
Réponds UNIQUEMENT avec un objet JSON valide, sans markdown, sans backticks, sans commentaires :
{
  ...
  "email_prospection": "OBJET: Sujet de l'email\\n\\nCorps de l'email de 150 mots max, professionnel, non alarmiste, personnalisé. Structure OBLIGATOIRE : 1) Accroche personnalisée sur l'entreprise (1 phrase). 2) Transition naturelle vers la cybersécurité (1 phrase). 3) Phrase de présentation au format EXACT : 'J\\'accompagne les entreprises comme la vôtre à sécuriser leur présence en ligne et leurs outils digitaux.' 4) Liste de 3 actions concrètes et techniques au format tiret, par exemple : '- Audit de votre CMS (WordPress, etc.) et de ses plugins', '- Vérification des vulnérabilités sur vos formulaires et espaces clients', '- Contrôle des fuites de données et de la conformité RGPD visible'. Les actions doivent être adaptées à ce que tu as observé sur le site. 5) Appel à l'action (1 phrase). 6) Formule de politesse courte."
}`;
